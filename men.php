...
<?php
    ...
    $select_products = $conn->prepare("SELECT * FROM `products` WHERE genner='nam' LIMIT $begin,3 ");
?>
	<head>
	...
	<div id="page">
		...
		<div class="colorlib-product">
			...
			<div class="row row-pb-md">
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">		
						<div class="product-entry border">
							...
							<div style="display:grid" >	
								<div class="flex-btn">
									<a href="cart.php?Order=<?= $fetch_products['id']; ?>" class="order"><i class="icon-shopping-cart2"; style="font-size: 24px;"></i></a>
									<a href="cart.php?Buy=<?= $fetch_products['id']; ?>" class="buy" onclick="return confirm('Buy this product?');">Buy</a>
								</div>
							</div>
							</div>
						</div>
				...
				<?php
							$sql_page= $conn->prepare("SELECT * FROM `products`WHERE genner='nam'");
							$sql_page->execute();
